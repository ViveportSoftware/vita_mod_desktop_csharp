    ...
    public static partial class BouncyCastle
    {
        public partial class Md5
        {
                    ...
                    CancellationToken cancellationToken)
            {
                ...
                catch (Exception e)
                {
                    ...
                    Logger.GetInstance(typeof(Md5)).Fatal($"Generating checksum by system in async error: {e}");
        ...
        public partial class Sha1
        {
                    ...
                    CancellationToken cancellationToken)
            {
                ...
                try
                {
                    return await DefaultSha1.DoGenerateInBase64Async(
                            file,
                            cancellationToken
                    ).ConfigureAwait(false);
                }
                catch (Exception e)
                {
                    ...
                    Logger.GetInstance(typeof(Sha1)).Fatal($"Generating checksum by system in async error: {e}");
                    UsingBouncyCastleFirst = true;
                }
                return await DoGenerateInBase64Async(
                        file,
                    ...
                    CancellationToken cancellationToken)
            {
                ...
                try
                {
                    return await DefaultSha1.DoGenerateInHexAsync(
                            file,
                            cancellationToken
                    ).ConfigureAwait(false);
                }
        ...
        public partial class Sha256
        {
                    ...
                    CancellationToken cancellationToken)
            {
                ...
                catch (Exception e)
                {
                    ...
                    Logger.GetInstance(typeof(Sha256)).Fatal($"Generating checksum by system in async error: {e}");
                    UsingBouncyCastleFirst = true;
                }
                return await DoGenerateInBase64Async(
                        file,
                    ...
                    CancellationToken cancellationToken)
            {
                ...
                try
                {
                    return await DefaultSha256.DoGenerateInHexAsync(
                            file,
                            cancellationToken
                    ).ConfigureAwait(false);
                }
